...
<head>
    ...
    <!-- Teachify Version -->
    <meta name="generator" content="UNIAL LMS v.{{config('app.version')}}" />
            ...
            <div id="page-wrapper">
                ...
                <div class="admin-footer">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <p class="m-0"><a href="https://themeqx.com/product/teachify-lms" target="_blank">UNIAL LMS</a> Version {{config('app.version')}}</p>
                            </div>
                        </div>
                    </div>
                </div>
