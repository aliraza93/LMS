                ...
                <div class="col-md-3">
                    <div class="footer-widget-wrap">
                        ...
                        <p class="footer-about-us-desc">
                            UNIAL LMS is a LMS platform that connect Teachers with Students globally. Teachers crate high quality course and present them in super easy way. UNIAL LMS created by <a href="https://themeqx.com" target="_blank">Themeqx</a>
                        </p>
                ...
                <div class="col-md-12">
                    <div class="footer-bottom-contents-wrap d-flex">
                        ...
                        <div class="footer-bottom-left d-flex">
                            <h5 class="text-warning">UNIAL LMS</h5>
                            <span class="ml-4">Copyright © 2020 UNIAL. All rights reserved.</span>
                        </div>
